...
import { useLinks, type Link } from "@/lib/links"
          ...
          <div className="max-w-md mx-auto mb-8 p-6 bg-white/10 backdrop-blur-md rounded-xl border border-white/20">
            <form onSubmit={handleAddProject} className="space-y-4">
              ...
              <div className="flex gap-2">
                <Button type="submit" className={`flex-1 ${editingProject ? 'bg-black/20 hover:bg-black/30 text-white backdrop-blur-sm border border-white/20' : 'bg-blue-600 hover:bg-blue-700'}`}>
